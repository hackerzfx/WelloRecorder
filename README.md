...
💎 **Crypto Payments** • 🎯 **Draggable Overlay** • ⏯️ **Pause/Resume** • 💾 **Ultra Portable** (<200MB)
...
1. **[Download Latest Release](https://github.com/hackerzfx/WelloRecorder/releases/latest)** (~190 MB)
...
*(New Compact Payment UI)*

## Known Issues

- **Netflix with XVast**: Currently disabled due to missing build tools (Use Chrome/Edge for other sites)
